...
import (
	...
	"crypto/des"
	"encoding/base64"
	consVal "newrpc/support/utils/constex"
)
...
//example:
//mysql := `root:dbjzcloudgame@(117.50.93.89:4040)/jz_cloud_game?charset=utf8&parseTime=true&loc=Asia%2FShanghai`
//ed := &EncryDecry{}
//src :=ed.EncryptPasswd(mysql)//加密后
//fmt.Println(src)

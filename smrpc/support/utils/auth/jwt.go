...
import (
	glocfg "newrpc/support/utils/cfg"
	"newrpc/support/utils/cfg/common"
	"newrpc/support/utils/cfg/config"
	stringex "newrpc/support/utils/stringex"
	"errors"
...
//	//保存
//	if err := redis.Redis().Set(conval.TokenIDKeyPrefix+subject.Account, tokenstring, conval.TokenExpiredDate).Err(); err != nil {
...
//	// 获取
//	tokenCached, err := redis.Redis().Get(conval.TokenIDKeyPrefix + subject.Account).Result()
//	if err != nil {
...
//	//保存
//	if err = redis.Redis().Del(conval.TokenIDKeyPrefix + subject.Account).Err(); err != nil {
